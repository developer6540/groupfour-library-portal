        ...
        <div className="payment-card mx-auto">
            ...
            <div className="d-flex align-items-center justify-content-between mb-3">
                ...
                <div className="d-flex align-items-center gap-1">
                    <FaCcVisa       size={32} style={{ color: "#1a1f71" }} title="Visa" />
                    <FaCcMastercard size={32} style={{ color: "#eb001b" }} title="Mastercard" />
                    <FaCcAmex       size={32} style={{ color: "#007bc1" }} title="American Express" />
                </div>
            </div>
