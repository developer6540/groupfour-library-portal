...
export default function BookStatusChart({data}) {
    ...
    const pieData = [
        { name: "Reserved book", value: data?.dashboard_count.TotalReservedBooks ?? "0", gradientId: "grad1" },
        { name: "Total Books Read", value: data?.dashboard_count.TotalBooksRead ?? "0", gradientId: "grad2" },
        { name: "Books Overdue", value: data?.dashboard_count.TotalBooksOverdue ?? "0", gradientId: "grad3" },
    ];
